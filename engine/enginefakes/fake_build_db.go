...
func (fake *FakeBuildDB) StartBuild(arg1 int, arg2 int, arg3 string, arg4 string) (bool, error) {
	...
	fake.recordInvocation("StartBuild", []interface{}{arg1, arg2, arg3, arg4})
...
func (fake *FakeBuildDB) AbortNotifier(arg1 int) (db.Notifier, error) {
	...
	fake.recordInvocation("AbortNotifier", []interface{}{arg1})
...
func (fake *FakeBuildDB) LeaseBuildTracking(logger lager.Logger, buildID int, interval time.Duration) (db.Lease, bool, error) {
	...
	fake.recordInvocation("LeaseBuildTracking", []interface{}{logger, buildID, interval})
...
func (fake *FakeBuildDB) FinishBuild(arg1 int, arg2 int, arg3 db.Status) error {
	...
	fake.recordInvocation("FinishBuild", []interface{}{arg1, arg2, arg3})
...
func (fake *FakeBuildDB) Invocations() map[string][][]interface{} {
...
func (fake *FakeBuildDB) recordInvocation(key string, args []interface{}) {
