...
func (fake *FakeEngineDB) SaveBuildEvent(buildID int, pipelineID int, event atc.Event) error {
	...
	fake.recordInvocation("SaveBuildEvent", []interface{}{buildID, pipelineID, event})
...
func (fake *FakeEngineDB) SaveBuildEngineMetadata(buildID int, metadata string) error {
	...
	fake.recordInvocation("SaveBuildEngineMetadata", []interface{}{buildID, metadata})
...
func (fake *FakeEngineDB) SaveImageResourceVersion(buildID int, planID atc.PlanID, identifier db.ResourceCacheIdentifier) error {
	...
	fake.recordInvocation("SaveImageResourceVersion", []interface{}{buildID, planID, identifier})
...
func (fake *FakeEngineDB) GetPipelineByTeamNameAndName(teamName string, pipelineName string) (db.SavedPipeline, error) {
	...
	fake.recordInvocation("GetPipelineByTeamNameAndName", []interface{}{teamName, pipelineName})
...
func (fake *FakeEngineDB) Invocations() map[string][][]interface{} {
...
func (fake *FakeEngineDB) recordInvocation(key string, args []interface{}) {
