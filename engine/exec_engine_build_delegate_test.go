	...
	Describe("InputDelegate", func() {
		...
		Describe("ImageVersionDetermined", func() {
			...
			It("calls through to the database", func() {
				...
				err := inputDelegate.ImageVersionDetermined(resourceCache)
	...
	Describe("ExecutionDelegate", func() {
		...
		Describe("ImageVersionDetermined", func() {
			...
			It("Calls through to the database", func() {
				...
				err := executionDelegate.ImageVersionDetermined(resourceCache)
				Expect(err).ToNot(HaveOccurred())
	...
	Describe("OutputDelegate", func() {
		...
		Describe("ImageVersionDetermined", func() {
			...
			It("calls through to the database", func() {
				...
				err := outputDelegate.ImageVersionDetermined(resourceCache)
				Expect(err).ToNot(HaveOccurred())
