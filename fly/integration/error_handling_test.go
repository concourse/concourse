...
var _ = Describe("Fly CLI", func() {
	...
	Context("when --team is set", func() {
		...
		DescribeTable("and the team does not exist",
			...
			Entry("containers command returns an error",
				exec.Command(flyPath, "-t", targetName, "containers", "--team", nonExistentTeam)),
			...
			Entry("execute command returns an error",
				exec.Command(flyPath, "-t", targetName, "execute", "-c", "fixtures/task-minimal.yml", "--team", nonExistentTeam)),
			...
			Entry("set-pipeline command returns an error",
				exec.Command(flyPath, "-t", targetName, "set-pipeline", "-p", "pipeline", "-c", "fixtures/testConfigValid.yml", "--team", nonExistentTeam)),
			...
			Entry("clear-resource-cache command returns an error",
				exec.Command(flyPath, "-t", targetName, "clear-resource-cache", "-r", "pipeline/resource", "--team", nonExistentTeam)),
			...
			Entry("clear-versions command returns an error",
				exec.Command(flyPath, "-t", targetName, "clear-versions", "--resource", "pipeline/resource", "--team", nonExistentTeam)),
		...
		DescribeTable("and you are NOT authorized to view the team",
			...
			Entry("containers command returns an error",
				exec.Command(flyPath, "-t", targetName, "containers", "--team", otherTeam)),
			Entry("trigger-job command returns an error",
			...
			Entry("execute command returns an error",
				exec.Command(flyPath, "-t", targetName, "execute", "-c", "fixtures/task-minimal.yml", "--team", otherTeam)),
			Entry("jobs command returns an error",
			...
			Entry("set-pipeline command returns an error",
				exec.Command(flyPath, "-t", targetName, "set-pipeline", "-p", "pipeline", "-c", "fixtures/testConfigValid.yml", "--team", otherTeam)),
			Entry("destroy-pipeline command returns an error",
			...
			Entry("clear-resource-cache command returns an error",
				exec.Command(flyPath, "-t", targetName, "clear-resource-cache", "-r", "pipeline/resource", "--team", otherTeam)),
			Entry("clear-task-cache command returns an error",
				exec.Command(flyPath, "-t", targetName, "clear-task-cache", "-j", "pipeline/job", "-s", "some-task-step", "--team", otherTeam)),
			Entry("clear-versions command returns an error",
				exec.Command(flyPath, "-t", targetName, "clear-versions", "--resource", "pipeline/resource", "--team", otherTeam)),
			Entry("rename-pipeline command returns an error",
