...
type FakeFetchContainerCreatorFactory struct {
	NewFetchContainerCreatorStub        func(logger lager.Logger, resourceTypes atc.ResourceTypes, tags atc.Tags, teamName string, session resource.Session, metadata resource.Metadata, imageFetchingDelegate worker.ImageFetchingDelegate) resource.FetchContainerCreator
...
func (fake *FakeFetchContainerCreatorFactory) NewFetchContainerCreator(logger lager.Logger, resourceTypes atc.ResourceTypes, tags atc.Tags, teamName string, session resource.Session, metadata resource.Metadata, imageFetchingDelegate worker.ImageFetchingDelegate) resource.FetchContainerCreator {
	...
	fake.newFetchContainerCreatorArgsForCall = append(fake.newFetchContainerCreatorArgsForCall, struct {
		...
		metadata              resource.Metadata
		imageFetchingDelegate worker.ImageFetchingDelegate
	}{logger, resourceTypes, tags, teamName, session, metadata, imageFetchingDelegate})
	fake.recordInvocation("NewFetchContainerCreator", []interface{}{logger, resourceTypes, tags, teamName, session, metadata, imageFetchingDelegate})
	fake.newFetchContainerCreatorMutex.Unlock()
	if fake.NewFetchContainerCreatorStub != nil {
		return fake.NewFetchContainerCreatorStub(logger, resourceTypes, tags, teamName, session, metadata, imageFetchingDelegate)
	} else {
