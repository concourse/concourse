...
type FakeFactory struct {
	GetStub        func(lager.Logger, exec.StepMetadata, exec.SourceName, worker.Identifier, worker.Metadata, exec.GetDelegate, atc.ResourceConfig, atc.Tags, string, atc.Params, atc.Version, atc.ResourceTypes, time.Duration, time.Duration) exec.StepFactory
	...
	PutStub        func(lager.Logger, exec.StepMetadata, worker.Identifier, worker.Metadata, exec.PutDelegate, atc.ResourceConfig, atc.Tags, string, atc.Params, atc.ResourceTypes, time.Duration, time.Duration) exec.StepFactory
	...
	DependentGetStub        func(lager.Logger, exec.StepMetadata, exec.SourceName, worker.Identifier, worker.Metadata, exec.GetDelegate, atc.ResourceConfig, atc.Tags, string, atc.Params, atc.ResourceTypes, time.Duration, time.Duration) exec.StepFactory
	...
	TaskStub        func(lager.Logger, exec.SourceName, worker.Identifier, worker.Metadata, exec.TaskDelegate, exec.Privileged, atc.Tags, string, exec.TaskConfigSource, atc.ResourceTypes, map[string]string, map[string]string, string, clock.Clock, time.Duration, time.Duration) exec.StepFactory
...
func (fake *FakeFactory) Get(arg1 lager.Logger, arg2 exec.StepMetadata, arg3 exec.SourceName, arg4 worker.Identifier, arg5 worker.Metadata, arg6 exec.GetDelegate, arg7 atc.ResourceConfig, arg8 atc.Tags, arg9 string, arg10 atc.Params, arg11 atc.Version, arg12 atc.ResourceTypes, arg13 time.Duration, arg14 time.Duration) exec.StepFactory {
	fake.getMutex.Lock()
...
func (fake *FakeFactory) GetArgsForCall(i int) (lager.Logger, exec.StepMetadata, exec.SourceName, worker.Identifier, worker.Metadata, exec.GetDelegate, atc.ResourceConfig, atc.Tags, string, atc.Params, atc.Version, atc.ResourceTypes, time.Duration, time.Duration) {
	fake.getMutex.RLock()
	defer fake.getMutex.RUnlock()
...
func (fake *FakeFactory) Put(arg1 lager.Logger, arg2 exec.StepMetadata, arg3 worker.Identifier, arg4 worker.Metadata, arg5 exec.PutDelegate, arg6 atc.ResourceConfig, arg7 atc.Tags, arg8 string, arg9 atc.Params, arg10 atc.ResourceTypes, arg11 time.Duration, arg12 time.Duration) exec.StepFactory {
	fake.putMutex.Lock()
...
func (fake *FakeFactory) PutArgsForCall(i int) (lager.Logger, exec.StepMetadata, worker.Identifier, worker.Metadata, exec.PutDelegate, atc.ResourceConfig, atc.Tags, string, atc.Params, atc.ResourceTypes, time.Duration, time.Duration) {
	fake.putMutex.RLock()
	defer fake.putMutex.RUnlock()
...
func (fake *FakeFactory) DependentGet(arg1 lager.Logger, arg2 exec.StepMetadata, arg3 exec.SourceName, arg4 worker.Identifier, arg5 worker.Metadata, arg6 exec.GetDelegate, arg7 atc.ResourceConfig, arg8 atc.Tags, arg9 string, arg10 atc.Params, arg11 atc.ResourceTypes, arg12 time.Duration, arg13 time.Duration) exec.StepFactory {
...
func (fake *FakeFactory) DependentGetArgsForCall(i int) (lager.Logger, exec.StepMetadata, exec.SourceName, worker.Identifier, worker.Metadata, exec.GetDelegate, atc.ResourceConfig, atc.Tags, string, atc.Params, atc.ResourceTypes, time.Duration, time.Duration) {
	fake.dependentGetMutex.RLock()
	defer fake.dependentGetMutex.RUnlock()
...
func (fake *FakeFactory) Task(arg1 lager.Logger, arg2 exec.SourceName, arg3 worker.Identifier, arg4 worker.Metadata, arg5 exec.TaskDelegate, arg6 exec.Privileged, arg7 atc.Tags, arg8 string, arg9 exec.TaskConfigSource, arg10 atc.ResourceTypes, arg11 map[string]string, arg12 map[string]string, arg13 string, arg14 clock.Clock, arg15 time.Duration, arg16 time.Duration) exec.StepFactory {
	fake.taskMutex.Lock()
...
func (fake *FakeFactory) TaskArgsForCall(i int) (lager.Logger, exec.SourceName, worker.Identifier, worker.Metadata, exec.TaskDelegate, exec.Privileged, atc.Tags, string, exec.TaskConfigSource, atc.ResourceTypes, map[string]string, map[string]string, string, clock.Clock, time.Duration, time.Duration) {
	fake.taskMutex.RLock()
	defer fake.taskMutex.RUnlock()
