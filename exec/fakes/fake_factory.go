...
type FakeFactory struct {
	GetStub        func(lager.Logger, exec.StepMetadata, exec.SourceName, worker.Identifier, worker.Metadata, exec.GetDelegate, atc.ResourceConfig, atc.Tags, atc.Params, atc.Version, atc.ResourceTypes, time.Duration) exec.StepFactory
	...
	PutStub        func(lager.Logger, exec.StepMetadata, worker.Identifier, worker.Metadata, exec.PutDelegate, atc.ResourceConfig, atc.Tags, atc.Params, atc.ResourceTypes, time.Duration, time.Duration) exec.StepFactory
	...
	DependentGetStub        func(lager.Logger, exec.StepMetadata, exec.SourceName, worker.Identifier, worker.Metadata, exec.GetDelegate, atc.ResourceConfig, atc.Tags, atc.Params, atc.ResourceTypes, time.Duration) exec.StepFactory
	...
	TaskStub        func(lager.Logger, exec.SourceName, worker.Identifier, worker.Metadata, exec.TaskDelegate, exec.Privileged, atc.Tags, exec.TaskConfigSource, atc.ResourceTypes, time.Duration, time.Duration, map[string]string, map[string]string) exec.StepFactory
...
func (fake *FakeFactory) Get(arg1 lager.Logger, arg2 exec.StepMetadata, arg3 exec.SourceName, arg4 worker.Identifier, arg5 worker.Metadata, arg6 exec.GetDelegate, arg7 atc.ResourceConfig, arg8 atc.Tags, arg9 atc.Params, arg10 atc.Version, arg11 atc.ResourceTypes, arg12 time.Duration) exec.StepFactory {
	fake.getMutex.Lock()
...
func (fake *FakeFactory) GetArgsForCall(i int) (lager.Logger, exec.StepMetadata, exec.SourceName, worker.Identifier, worker.Metadata, exec.GetDelegate, atc.ResourceConfig, atc.Tags, atc.Params, atc.Version, atc.ResourceTypes, time.Duration) {
	fake.getMutex.RLock()
	defer fake.getMutex.RUnlock()
...
func (fake *FakeFactory) Put(arg1 lager.Logger, arg2 exec.StepMetadata, arg3 worker.Identifier, arg4 worker.Metadata, arg5 exec.PutDelegate, arg6 atc.ResourceConfig, arg7 atc.Tags, arg8 atc.Params, arg9 atc.ResourceTypes, arg10 time.Duration, arg11 time.Duration) exec.StepFactory {
	fake.putMutex.Lock()
...
func (fake *FakeFactory) PutArgsForCall(i int) (lager.Logger, exec.StepMetadata, worker.Identifier, worker.Metadata, exec.PutDelegate, atc.ResourceConfig, atc.Tags, atc.Params, atc.ResourceTypes, time.Duration, time.Duration) {
	fake.putMutex.RLock()
	defer fake.putMutex.RUnlock()
...
func (fake *FakeFactory) DependentGet(arg1 lager.Logger, arg2 exec.StepMetadata, arg3 exec.SourceName, arg4 worker.Identifier, arg5 worker.Metadata, arg6 exec.GetDelegate, arg7 atc.ResourceConfig, arg8 atc.Tags, arg9 atc.Params, arg10 atc.ResourceTypes, arg11 time.Duration) exec.StepFactory {
...
func (fake *FakeFactory) DependentGetArgsForCall(i int) (lager.Logger, exec.StepMetadata, exec.SourceName, worker.Identifier, worker.Metadata, exec.GetDelegate, atc.ResourceConfig, atc.Tags, atc.Params, atc.ResourceTypes, time.Duration) {
	fake.dependentGetMutex.RLock()
	defer fake.dependentGetMutex.RUnlock()
...
func (fake *FakeFactory) Task(arg1 lager.Logger, arg2 exec.SourceName, arg3 worker.Identifier, arg4 worker.Metadata, arg5 exec.TaskDelegate, arg6 exec.Privileged, arg7 atc.Tags, arg8 exec.TaskConfigSource, arg9 atc.ResourceTypes, arg10 time.Duration, arg11 time.Duration, arg12 map[string]string, arg13 map[string]string) exec.StepFactory {
	fake.taskMutex.Lock()
...
func (fake *FakeFactory) TaskArgsForCall(i int) (lager.Logger, exec.SourceName, worker.Identifier, worker.Metadata, exec.TaskDelegate, exec.Privileged, atc.Tags, exec.TaskConfigSource, atc.ResourceTypes, time.Duration, time.Duration, map[string]string, map[string]string) {
	fake.taskMutex.RLock()
	defer fake.taskMutex.RUnlock()
