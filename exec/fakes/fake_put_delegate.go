...
func (fake *FakePutDelegate) FindLongLivedContainers(jobName string, pipelineID int) ([]db.SavedContainer, error) {
...
func (fake *FakePutDelegate) FindLongLivedContainersCallCount() int {
...
func (fake *FakePutDelegate) FindLongLivedContainersArgsForCall(i int) (string, int) {
	fake.findLongLivedContainersMutex.RLock()
	defer fake.findLongLivedContainersMutex.RUnlock()
	return fake.findLongLivedContainersArgsForCall[i].jobName, fake.findLongLivedContainersArgsForCall[i].pipelineID
}

func (fake *FakePutDelegate) FindLongLivedContainersReturns(result1 []db.SavedContainer, result2 error) {
