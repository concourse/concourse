...
type FakeImageResourceFetcher struct {
	FetchStub        func(logger lager.Logger, resourceUser dbng.ResourceUser, signals <-chan os.Signal, imageResourceType string, imageResourceSource atc.Source, tags atc.Tags, teamID int, customTypes atc.VersionedResourceTypes, imageFetchingDelegate worker.ImageFetchingDelegate, privileged bool) (worker.Volume, io.ReadCloser, atc.Version, error)
...
func (fake *FakeImageResourceFetcher) Fetch(logger lager.Logger, resourceUser dbng.ResourceUser, signals <-chan os.Signal, imageResourceType string, imageResourceSource atc.Source, tags atc.Tags, teamID int, customTypes atc.VersionedResourceTypes, imageFetchingDelegate worker.ImageFetchingDelegate, privileged bool) (worker.Volume, io.ReadCloser, atc.Version, error) {
	...
	fake.fetchArgsForCall = append(fake.fetchArgsForCall, struct {
		...
		imageFetchingDelegate worker.ImageFetchingDelegate
		privileged            bool
	}{logger, resourceUser, signals, imageResourceType, imageResourceSource, tags, teamID, customTypes, imageFetchingDelegate, privileged})
	fake.recordInvocation("Fetch", []interface{}{logger, resourceUser, signals, imageResourceType, imageResourceSource, tags, teamID, customTypes, imageFetchingDelegate, privileged})
	fake.fetchMutex.Unlock()
	if fake.FetchStub != nil {
		return fake.FetchStub(logger, resourceUser, signals, imageResourceType, imageResourceSource, tags, teamID, customTypes, imageFetchingDelegate, privileged)
	}
	if specificReturn {
...
func (fake *FakeImageResourceFetcher) FetchArgsForCall(i int) (lager.Logger, dbng.ResourceUser, <-chan os.Signal, string, atc.Source, atc.Tags, int, atc.VersionedResourceTypes, worker.ImageFetchingDelegate, bool) {
	fake.fetchMutex.RLock()
	defer fake.fetchMutex.RUnlock()
