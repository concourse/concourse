...
type GardenBackend struct {
	...
	RestrictedNetworks []string      `long:"restricted-networks" description:"Network ranges to which traffic from containers will be restricted. Can be specified multiple times."`
