...
func (fake *FakeWorker) CheckContainerResourceTypeVersion(arg1 lager.Logger, arg2 db.SavedContainer) (bool, error) {
...
func (fake *FakeWorker) CheckContainerResourceTypeVersionCallCount() int {
...
func (fake *FakeWorker) CheckContainerResourceTypeVersionArgsForCall(i int) (lager.Logger, db.SavedContainer) {
	fake.checkContainerResourceTypeVersionMutex.RLock()
	defer fake.checkContainerResourceTypeVersionMutex.RUnlock()
	return fake.checkContainerResourceTypeVersionArgsForCall[i].arg1, fake.checkContainerResourceTypeVersionArgsForCall[i].arg2
}

func (fake *FakeWorker) CheckContainerResourceTypeVersionReturns(result1 bool, result2 error) {
