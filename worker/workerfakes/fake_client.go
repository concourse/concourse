...
func (fake *FakeClient) CreateContainerNG(arg1 lager.Logger, arg2 <-chan os.Signal, arg3 worker.ImageFetchingDelegate, arg4 worker.Identifier, arg5 worker.Metadata, arg6 worker.ContainerSpec, arg7 atc.ResourceTypes, arg8 map[string]string) (worker.Container, error) {
...
func (fake *FakeClient) CreateContainerNGCallCount() int {
	fake.createContainerNGMutex.RLock()
	defer fake.createContainerNGMutex.RUnlock()
	return len(fake.createContainerNGArgsForCall)
}

func (fake *FakeClient) CreateContainerNGArgsForCall(i int) (lager.Logger, <-chan os.Signal, worker.ImageFetchingDelegate, worker.Identifier, worker.Metadata, worker.ContainerSpec, atc.ResourceTypes, map[string]string) {
	fake.createContainerNGMutex.RLock()
	defer fake.createContainerNGMutex.RUnlock()
...
func (fake *FakeClient) CreateContainerNGReturns(result1 worker.Container, result2 error) {
