...
func (fake *FakeTask) Checkpoint(arg1 context.Context, arg2 ...containerd.CheckpointTaskOpts) (containerd.Image, error) {
	...
	fake.recordInvocation("Checkpoint", []any{arg1, arg2})
...
func (fake *FakeTask) Exec(arg1 context.Context, arg2 string, arg3 *specs.Process, arg4 cio.Creator) (containerd.Process, error) {
	...
	fake.recordInvocation("Exec", []any{arg1, arg2, arg3, arg4})
...
func (fake *FakeTask) LoadProcess(arg1 context.Context, arg2 string, arg3 cio.Attach) (containerd.Process, error) {
	...
	fake.recordInvocation("LoadProcess", []any{arg1, arg2, arg3})
...
func (fake *FakeTask) Pids(arg1 context.Context) ([]containerd.ProcessInfo, error) {
	...
	fake.recordInvocation("Pids", []any{arg1})
...
func (fake *FakeTask) Resume(arg1 context.Context) error {
	...
	fake.recordInvocation("Resume", []any{arg1})
...
func (fake *FakeTask) Spec(arg1 context.Context) (*oci.Spec, error) {
	fake.specMutex.Lock()
...
func (fake *FakeTask) SpecCalls(stub func(context.Context) (*oci.Spec, error)) {
	fake.specMutex.Lock()
...
func (fake *FakeTask) SpecReturns(result1 *oci.Spec, result2 error) {
	fake.specMutex.Lock()
	defer fake.specMutex.Unlock()
	fake.SpecStub = nil
...
func (fake *FakeTask) SpecReturnsOnCall(i int, result1 *oci.Spec, result2 error) {
	fake.specMutex.Lock()
	defer fake.specMutex.Unlock()
	fake.SpecStub = nil
...
func (fake *FakeTask) Invocations() map[string][][]any {
...
func (fake *FakeTask) recordInvocation(key string, args []any) {
