...
var seccomp = &specs.LinuxSeccomp{
	...
	Syscalls: []specs.LinuxSyscall{
		...
		AllowSyscall("membarrier"),
		AllowSyscall("memfd_create"),
		AllowSyscall("memfd_secret"),
