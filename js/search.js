...
var _user$project$Main$emphasize = F2(
	function (matches, str) {
		...
		var hl = F2(
			function ($char, _p0) {
				var _p1 = _p0;
				var _p2 = _p1._1;
				var txt = _elm_lang$html$Html$text(
					_elm_lang$core$String$fromChar($char));
				var ele = isKey(_p2) ? A2(
...
var _user$project$Main$viewDocumentResult = F3(
	function (model, _p3, doc) {
		var _p4 = _p3;
		return A2(
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$href(doc.location),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: A2(
							...
							{ctor: '[]'},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('result-header'),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
										_0: A2(
											...
											{ctor: '[]'},
											A2(_user$project$Main$emphasize, _p4._1.matches, doc.title)),
										_1: {
											ctor: '::',
											_0: function () {
												if (_elm_lang$core$Native_Utils.eq(doc.sectionTag, _p4._0)) {
													return _elm_lang$html$Html$text('');
												} else {
													var _p5 = A2(_elm_lang$core$Dict$get, doc.sectionTag, model.docs);
													if (_p5.ctor === 'Nothing') {
														return _elm_lang$html$Html$text('');
													} else {
														return A2(
															...
															{
																ctor: '::',
																_0: _elm_lang$html$Html$text(_p5._0.title),
																_1: {ctor: '[]'}
															});
													}
												}
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$core$String$isEmpty(doc.text) ? _elm_lang$html$Html$text('') : A2(
										_elm_lang$html$Html$p,
										{ctor: '[]'},
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text(
												A2(_elm_lang$core$String$left, 130, doc.text)),
											_1: {
												ctor: '::',
												_0: (_elm_lang$core$Native_Utils.cmp(
													_elm_lang$core$String$length(doc.text),
													130) > 0) ? _elm_lang$html$Html$text('...') : _elm_lang$html$Html$text(''),
												_1: {ctor: '[]'}
											}
										}),
									_1: {ctor: '[]'}
...
var _user$project$Main$viewResult = F2(
	function (model, _p6) {
		var _p7 = _p6;
		var _p8 = _p7._0;
		return A2(
			...
			A2(
				_user$project$Main$viewDocumentResult,
				model,
				{ctor: '_Tuple2', _0: _p8, _1: _p7._1}),
			A2(_elm_lang$core$Dict$get, _p8, model.docs));
	});
var _user$project$Main$containsFuzzyChars = F2(
	function (_p9, res) {
		return _elm_lang$core$Native_Utils.cmp(res.score, 10000) < 0;
	});
var _user$project$Main$match = F3(
	function (query, tag, doc) {
		var result = A4(
			_tripokey$elm_fuzzy$Fuzzy$match,
			{
				ctor: '::',
				_0: _tripokey$elm_fuzzy$Fuzzy$insertPenalty(100),
				_1: {ctor: '[]'}
			},
			{ctor: '[]'},
			query,
			_elm_lang$core$String$toLower(doc.title));
		return _elm_lang$core$Native_Utils.update(
			result,
			{score: result.score + (100 * doc.depth)});
	});
var _user$project$Main$performSearch = function (model) {
	var _p10 = {ctor: '_Tuple2', _0: model.query, _1: model.docs};
	if (_p10._0 === '') {
		return _elm_lang$core$Native_Utils.update(
			model,
			{result: _elm_lang$core$Dict$empty});
	} else {
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				result: A2(
					_elm_lang$core$Dict$filter,
					_user$project$Main$containsFuzzyChars,
					A2(
						_elm_lang$core$Dict$map,
						_user$project$Main$match(_p10._0),
						_p10._1))
			});
	}
};
var _user$project$Main$update = F2(
	function (msg, model) {
		var _p11 = msg;
		if (_p11.ctor === 'DocumentsFetched') {
			if (_p11._0.ctor === 'Ok') {
				return {
					ctor: '_Tuple2',
					_0: _user$project$Main$performSearch(
				...
				return A3(
					...
					_elm_lang$core$Basics$always,
					A2(_elm_lang$core$Debug$log, 'failed to load index', _p11._0._0),
			...
			return {
				...
				_0: _user$project$Main$performSearch(
					_elm_lang$core$Native_Utils.update(
						model,
						{
							query: _elm_lang$core$String$toLower(_p11._0)
						})),
				_1: _elm_lang$core$Platform_Cmd$none
			};
		}
	});
var _user$project$Main$Doc = F4(
	function (a, b, c, d) {
		return {tag: a, title: b, text: c, location: d};
	});
var _user$project$Main$Model = F3(
	function (a, b, c) {
		return {query: a, docs: b, result: c};
	});
var _user$project$Main$BooklitDocument = F5(
	function (a, b, c, d, e) {
		return {title: a, text: b, location: c, depth: d, sectionTag: e};
	});
var _user$project$Main$decodeSearchDocument = A2(
	...
	A2(
		...
		A2(
			...
			A2(
				...
				A2(
					_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
					_elm_lang$core$Json_Decode$succeed(_user$project$Main$BooklitDocument),
	...
	A2(_elm_lang$core$Json_Decode$field, 'section_tag', _elm_lang$core$Json_Decode$string));
var _user$project$Main$decodeSearchIndex = _elm_lang$core$Json_Decode$dict(_user$project$Main$decodeSearchDocument);
				...
				_elm_lang$html$Html$input,
				{
					...
					_1: {
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$placeholder('Search the docs…'),
								_1: {
									ctor: '::',
				...
				_0: A2(
					...
					A2(
						...
						A2(
							...
							_elm_lang$core$Dict$toList(model.result)))),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$Main$DocumentsFetched = function (a) {
	return {ctor: 'DocumentsFetched', _0: a};
};
var _user$project$Main$init = {
	ctor: '_Tuple2',
	_0: {docs: _elm_lang$core$Dict$empty, query: '', result: _elm_lang$core$Dict$empty},
	_1: _elm_lang$core$Platform_Cmd$batch(
		{
			ctor: '::',
			_0: A2(
				_elm_lang$http$Http$send,
				_user$project$Main$DocumentsFetched,
				A2(_elm_lang$http$Http$get, 'search_index.json', _user$project$Main$decodeSearchIndex)),
			_1: {ctor: '[]'}
		})
};
