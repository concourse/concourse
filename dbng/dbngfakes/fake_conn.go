...
func (fake *FakeConn) Bus() dbng.NotificationsBus {
	fake.busMutex.Lock()
...
func (fake *FakeConn) BusReturns(result1 dbng.NotificationsBus) {
	fake.BusStub = nil
...
func (fake *FakeConn) BusReturnsOnCall(i int, result1 dbng.NotificationsBus) {
	fake.BusStub = nil
...
func (fake *FakeConn) EncryptionStrategy() dbng.EncryptionStrategy {
...
func (fake *FakeConn) EncryptionStrategyReturns(result1 dbng.EncryptionStrategy) {
...
func (fake *FakeConn) EncryptionStrategyReturnsOnCall(i int, result1 dbng.EncryptionStrategy) {
	fake.EncryptionStrategyStub = nil
