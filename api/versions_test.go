	...
	Describe("GET /api/v1/teams/:team_name/pipelines/:pipeline_name/resources/:resource_name/versions/:resource_version_id/input_to", func() {
		...
		Context("when getting the builds succeeds", func() {
			BeforeEach(func() {
				...
				buildDB1.IDReturns(1024)
				buildDB1.NameReturns("5")
				buildDB1.JobNameReturns("some-job")
				buildDB1.PipelineNameReturns("a-pipeline")
				buildDB1.TeamNameReturns("a-team")
				...
				buildDB2.IDReturns(1025)
				buildDB2.NameReturns("6")
				buildDB2.JobNameReturns("some-job")
				buildDB2.PipelineNameReturns("a-pipeline")
				buildDB2.TeamNameReturns("a-team")
				buildDB2.StatusReturns(db.StatusSucceeded)
				buildDB2.StartTimeReturns(time.Unix(200, 0))
				buildDB2.EndTimeReturns(time.Unix(300, 0))
