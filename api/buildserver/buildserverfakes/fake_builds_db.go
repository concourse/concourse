...
func (fake *FakeBuildsDB) GetBuildEvents(buildID int, from uint) (db.EventSource, error) {
	...
	fake.recordInvocation("GetBuildEvents", []interface{}{buildID, from})
...
func (fake *FakeBuildsDB) GetBuildResources(buildID int) ([]db.BuildInput, []db.BuildOutput, error) {
	...
	fake.recordInvocation("GetBuildResources", []interface{}{buildID})
...
func (fake *FakeBuildsDB) GetBuildPreparation(buildID int) (db.BuildPreparation, bool, error) {
	...
	fake.recordInvocation("GetBuildPreparation", []interface{}{buildID})
...
func (fake *FakeBuildsDB) GetConfigByBuildID(buildID int) (atc.Config, db.ConfigVersion, error) {
	...
	fake.recordInvocation("GetConfigByBuildID", []interface{}{buildID})
