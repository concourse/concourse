...
func (fake *FakeContainerReaperDB) GetPipelineByID(pipelineID int) (db.SavedPipeline, error) {
...
func (fake *FakeContainerReaperDB) GetPipelineByIDCallCount() int {
	fake.getPipelineByIDMutex.RLock()
	defer fake.getPipelineByIDMutex.RUnlock()
	return len(fake.getPipelineByIDArgsForCall)
}

func (fake *FakeContainerReaperDB) GetPipelineByIDArgsForCall(i int) int {
	fake.getPipelineByIDMutex.RLock()
	defer fake.getPipelineByIDMutex.RUnlock()
	return fake.getPipelineByIDArgsForCall[i].pipelineID
}

func (fake *FakeContainerReaperDB) GetPipelineByIDReturns(result1 db.SavedPipeline, result2 error) {
...
func (fake *FakeContainerReaperDB) FindOrphanContainersWithInfiniteTTL() ([]db.SavedContainer, error) {
	...
	fake.recordInvocation("FindOrphanContainersWithInfiniteTTL", []interface{}{})
...
func (fake *FakeContainerReaperDB) FindContainersFromSuccessfulBuildsWithInfiniteTTL() ([]db.SavedContainer, error) {
	...
	fake.recordInvocation("FindContainersFromSuccessfulBuildsWithInfiniteTTL", []interface{}{})
...
func (fake *FakeContainerReaperDB) FindContainersFromUnsuccessfulBuildsWithInfiniteTTL() ([]db.SavedContainer, error) {
	...
	fake.recordInvocation("FindContainersFromUnsuccessfulBuildsWithInfiniteTTL", []interface{}{})
...
func (fake *FakeContainerReaperDB) Invocations() map[string][][]interface{} {
...
func (fake *FakeContainerReaperDB) recordInvocation(key string, args []interface{}) {
