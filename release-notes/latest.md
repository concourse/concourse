...
#### <sub><sup><a name="5308" href="#5308">:link:</a></sup></sub> feature

* @jhosteny changed the [badge endpoints](https://concourse-ci.org/observation.html#badges) to be accessible when unauthenticated if `default-badge-visiblity` is set to `public` - this means that it is now possible to show the status of a private pipeline or job in a README on a code-hosting site. #5308
