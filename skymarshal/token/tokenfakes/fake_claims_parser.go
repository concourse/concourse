...
func (fake *FakeClaimsParser) ParseClaims(arg1 string) (db.Claims, error) {
	...
	fake.recordInvocation("ParseClaims", []any{arg1})
...
func (fake *FakeClaimsParser) Invocations() map[string][][]any {
...
func (fake *FakeClaimsParser) recordInvocation(key string, args []any) {
