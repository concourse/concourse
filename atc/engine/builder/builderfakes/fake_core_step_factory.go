...
type FakeCoreStepFactory struct {
	...
	CheckStepStub        func(atc.Plan, exec.StepMetadata, db.ContainerMetadata, builder.DelegateFactory) exec.Step
	checkStepMutex       sync.RWMutex
	checkStepArgsForCall []struct {
		arg1 atc.Plan
		arg2 exec.StepMetadata
		arg3 db.ContainerMetadata
		arg4 builder.DelegateFactory
	}
	...
	GetStepStub        func(atc.Plan, exec.StepMetadata, db.ContainerMetadata, builder.DelegateFactory) exec.Step
	...
	LoadVarStepStub        func(atc.Plan, exec.StepMetadata, builder.DelegateFactory) exec.Step
	...
	PutStepStub        func(atc.Plan, exec.StepMetadata, db.ContainerMetadata, builder.DelegateFactory) exec.Step
	...
	SetPipelineStepStub        func(atc.Plan, exec.StepMetadata, builder.DelegateFactory) exec.Step
	...
	TaskStepStub        func(atc.Plan, exec.StepMetadata, db.ContainerMetadata, builder.DelegateFactory) exec.Step
...
func (fake *FakeCoreStepFactory) CheckStep(arg1 atc.Plan, arg2 exec.StepMetadata, arg3 db.ContainerMetadata, arg4 builder.DelegateFactory) exec.Step {
...
func (fake *FakeCoreStepFactory) CheckStepCalls(stub func(atc.Plan, exec.StepMetadata, db.ContainerMetadata, builder.DelegateFactory) exec.Step) {
	fake.checkStepMutex.Lock()
	defer fake.checkStepMutex.Unlock()
	fake.CheckStepStub = stub
}

func (fake *FakeCoreStepFactory) CheckStepArgsForCall(i int) (atc.Plan, exec.StepMetadata, db.ContainerMetadata, builder.DelegateFactory) {
	fake.checkStepMutex.RLock()
	defer fake.checkStepMutex.RUnlock()
...
func (fake *FakeCoreStepFactory) GetStep(arg1 atc.Plan, arg2 exec.StepMetadata, arg3 db.ContainerMetadata, arg4 builder.DelegateFactory) exec.Step {
...
func (fake *FakeCoreStepFactory) GetStepCalls(stub func(atc.Plan, exec.StepMetadata, db.ContainerMetadata, builder.DelegateFactory) exec.Step) {
	fake.getStepMutex.Lock()
	defer fake.getStepMutex.Unlock()
	fake.GetStepStub = stub
}

func (fake *FakeCoreStepFactory) GetStepArgsForCall(i int) (atc.Plan, exec.StepMetadata, db.ContainerMetadata, builder.DelegateFactory) {
	fake.getStepMutex.RLock()
	defer fake.getStepMutex.RUnlock()
...
func (fake *FakeCoreStepFactory) LoadVarStep(arg1 atc.Plan, arg2 exec.StepMetadata, arg3 builder.DelegateFactory) exec.Step {
...
func (fake *FakeCoreStepFactory) LoadVarStepCalls(stub func(atc.Plan, exec.StepMetadata, builder.DelegateFactory) exec.Step) {
	fake.loadVarStepMutex.Lock()
	defer fake.loadVarStepMutex.Unlock()
	fake.LoadVarStepStub = stub
}

func (fake *FakeCoreStepFactory) LoadVarStepArgsForCall(i int) (atc.Plan, exec.StepMetadata, builder.DelegateFactory) {
	fake.loadVarStepMutex.RLock()
	defer fake.loadVarStepMutex.RUnlock()
...
func (fake *FakeCoreStepFactory) PutStep(arg1 atc.Plan, arg2 exec.StepMetadata, arg3 db.ContainerMetadata, arg4 builder.DelegateFactory) exec.Step {
...
func (fake *FakeCoreStepFactory) PutStepCalls(stub func(atc.Plan, exec.StepMetadata, db.ContainerMetadata, builder.DelegateFactory) exec.Step) {
	fake.putStepMutex.Lock()
	defer fake.putStepMutex.Unlock()
	fake.PutStepStub = stub
}

func (fake *FakeCoreStepFactory) PutStepArgsForCall(i int) (atc.Plan, exec.StepMetadata, db.ContainerMetadata, builder.DelegateFactory) {
	fake.putStepMutex.RLock()
	defer fake.putStepMutex.RUnlock()
...
func (fake *FakeCoreStepFactory) SetPipelineStep(arg1 atc.Plan, arg2 exec.StepMetadata, arg3 builder.DelegateFactory) exec.Step {
...
func (fake *FakeCoreStepFactory) SetPipelineStepCalls(stub func(atc.Plan, exec.StepMetadata, builder.DelegateFactory) exec.Step) {
	fake.setPipelineStepMutex.Lock()
	defer fake.setPipelineStepMutex.Unlock()
	fake.SetPipelineStepStub = stub
}

func (fake *FakeCoreStepFactory) SetPipelineStepArgsForCall(i int) (atc.Plan, exec.StepMetadata, builder.DelegateFactory) {
	fake.setPipelineStepMutex.RLock()
	defer fake.setPipelineStepMutex.RUnlock()
...
func (fake *FakeCoreStepFactory) TaskStep(arg1 atc.Plan, arg2 exec.StepMetadata, arg3 db.ContainerMetadata, arg4 builder.DelegateFactory) exec.Step {
...
func (fake *FakeCoreStepFactory) TaskStepCalls(stub func(atc.Plan, exec.StepMetadata, db.ContainerMetadata, builder.DelegateFactory) exec.Step) {
	fake.taskStepMutex.Lock()
	defer fake.taskStepMutex.Unlock()
	fake.TaskStepStub = stub
}

func (fake *FakeCoreStepFactory) TaskStepArgsForCall(i int) (atc.Plan, exec.StepMetadata, db.ContainerMetadata, builder.DelegateFactory) {
	fake.taskStepMutex.RLock()
	defer fake.taskStepMutex.RUnlock()
...
var _ builder.CoreStepFactory = new(FakeCoreStepFactory)
