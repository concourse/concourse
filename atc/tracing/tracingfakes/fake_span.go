...
type FakeSpan struct {
	...
	LinkStub        func(core.SpanContext, ...core.KeyValue)
...
func (fake *FakeSpan) Link(arg1 core.SpanContext, arg2 ...core.KeyValue) {
	fake.linkMutex.Lock()
	...
	if fake.LinkStub != nil {
		fake.LinkStub(arg1, arg2...)
	}
}

func (fake *FakeSpan) LinkCallCount() int {
	fake.linkMutex.RLock()
	defer fake.linkMutex.RUnlock()
	return len(fake.linkArgsForCall)
}

func (fake *FakeSpan) LinkCalls(stub func(core.SpanContext, ...core.KeyValue)) {
	fake.linkMutex.Lock()
	defer fake.linkMutex.Unlock()
	fake.LinkStub = stub
}

func (fake *FakeSpan) LinkArgsForCall(i int) (core.SpanContext, []core.KeyValue) {
	fake.linkMutex.RLock()
	defer fake.linkMutex.RUnlock()
...
func (fake *FakeSpan) SetAttribute(arg1 core.KeyValue) {
	...
	fake.recordInvocation("SetAttribute", []interface{}{arg1})
	fake.setAttributeMutex.Unlock()
	if fake.SetAttributeStub != nil {
		fake.SetAttributeStub(arg1)
	}
}
...
func (fake *FakeSpan) SetAttributeCalls(stub func(core.KeyValue)) {
	fake.setAttributeMutex.Lock()
	defer fake.setAttributeMutex.Unlock()
	fake.SetAttributeStub = stub
}

func (fake *FakeSpan) SetAttributeArgsForCall(i int) core.KeyValue {
	fake.setAttributeMutex.RLock()
	defer fake.setAttributeMutex.RUnlock()
