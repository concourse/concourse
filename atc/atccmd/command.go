...
type RunCommand struct {
	...
	DefaultBadgeVisibility string `long:"default-badge-visibility" default:"pipeline-visibility" choice:"pipeline-visibility" choice:"public" description:"Default visibility of pipeline and job badges."`
}
...
func (cmd *RunCommand) constructAPIMembers(
	...
	defaultBadgeVisibilityFactory := auth.NewDefaultBadgeVisibilityFactory(cmd.DefaultBadgeVisibility)
...
func (cmd *RunCommand) constructAPIHandler(
	...
	dbWall db.Wall,
	defaultBadgeVisibilityFactory auth.DefaultBadgeVisibilityFactory,
) (http.Handler, error) {
	...
	checkBadgeAccessHandlerFactory := auth.NewCheckBadgeAccessHandlerFactory(teamFactory, defaultBadgeVisibilityFactory)
