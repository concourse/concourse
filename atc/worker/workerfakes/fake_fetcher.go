...
func (fake *FakeFetcher) FetchArgsForCall(i int) (context.Context, lager.Logger, db.ContainerMetadata, worker.Worker, worker.ContainerSpec, runtime.ProcessSpec, resource.Resource, atc.VersionedResourceTypes, atc.Source, atc.Params, db.ContainerOwner, string, worker.ImageFetchingDelegate, db.UsedResourceCache) {
	fake.fetchMutex.RLock()
	defer fake.fetchMutex.RUnlock()
