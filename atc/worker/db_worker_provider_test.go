...
var _ = Describe("DBProvider", func() {
	...
	BeforeEach(func() {
		...
		fakeWorker1.ExpectedContainersReturns(2)
		...
		fakeWorker2.ExpectedContainersReturns(2)
		...
		Context("when the database yields workers", func() {
			...
			Context("when some of the workers returned are stalled or landing", func() {
				BeforeEach(func() {
					...
					landingWorker.ExpectedContainersReturns(5)
					...
					stalledWorker.ExpectedContainersReturns(0)
			...
			Context("when a worker's major version is higher or lower than the atc worker version", func() {
				BeforeEach(func() {
					...
					worker1.ExpectedContainersReturns(5)
					...
					worker2.ExpectedContainersReturns(0)
					...
					worker3.ExpectedContainersReturns(0)
