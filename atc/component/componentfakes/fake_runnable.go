...
func (fake *FakeRunnable) Run(arg1 context.Context) error {
	fake.runMutex.Lock()
...
func (fake *FakeRunnable) RunCalls(stub func(context.Context) error) {
	fake.runMutex.Lock()
...
var _ component.Runnable = new(FakeRunnable)
