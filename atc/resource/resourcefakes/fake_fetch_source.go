...
func (fake *FakeFetchSource) CreateCalls(stub func(context.Context) (worker.Volume, error)) {
	fake.createMutex.Lock()
...
func (fake *FakeFetchSource) FindCalls(stub func() (worker.Volume, bool, error)) {
	fake.findMutex.Lock()
