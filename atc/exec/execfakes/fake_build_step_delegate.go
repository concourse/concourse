...
func (fake *FakeBuildStepDelegate) FetchImage(arg1 context.Context, arg2 atc.Plan, arg3 *atc.Plan, arg4 bool) (worker.ImageSpec, db.UsedResourceCache, error) {
...
func (fake *FakeBuildStepDelegate) FetchImageCalls(stub func(context.Context, atc.Plan, *atc.Plan, bool) (worker.ImageSpec, db.UsedResourceCache, error)) {
	fake.fetchImageMutex.Lock()
...
func (fake *FakeBuildStepDelegate) FetchImageReturns(result1 worker.ImageSpec, result2 db.UsedResourceCache, result3 error) {
	fake.fetchImageMutex.Lock()
	defer fake.fetchImageMutex.Unlock()
...
func (fake *FakeBuildStepDelegate) FetchImageReturnsOnCall(i int, result1 worker.ImageSpec, result2 db.UsedResourceCache, result3 error) {
	fake.fetchImageMutex.Lock()
	defer fake.fetchImageMutex.Unlock()
	fake.FetchImageStub = nil
...
func (fake *FakeBuildStepDelegate) VariablesReturnsOnCall(i int, result1 vars.Variables) {
	fake.variablesMutex.Lock()
	defer fake.variablesMutex.Unlock()
	fake.VariablesStub = nil
