...
func (fake *FakeCheckDelegate) FetchImage(arg1 context.Context, arg2 atc.Plan, arg3 *atc.Plan, arg4 bool) (worker.ImageSpec, error) {
...
func (fake *FakeCheckDelegate) FetchImageCalls(stub func(context.Context, atc.Plan, *atc.Plan, bool) (worker.ImageSpec, error)) {
	fake.fetchImageMutex.Lock()
