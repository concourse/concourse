...
func (fake *FakePutDelegate) HasDoneSuccessfullyCallCount() int {
...
func (fake *FakePutDelegate) HasDoneSuccessfullyCalls(stub func() bool) {
	fake.hasDoneSuccessfullyMutex.Lock()
	defer fake.hasDoneSuccessfullyMutex.Unlock()
	fake.HasDoneSuccessfullyStub = stub
}

func (fake *FakePutDelegate) HasDoneSuccessfullyReturns(result1 bool) {
	fake.hasDoneSuccessfullyMutex.Lock()
	defer fake.hasDoneSuccessfullyMutex.Unlock()
...
func (fake *FakePutDelegate) HasDoneSuccessfullyReturnsOnCall(i int, result1 bool) {
	fake.hasDoneSuccessfullyMutex.Lock()
	defer fake.hasDoneSuccessfullyMutex.Unlock()
	fake.HasDoneSuccessfullyStub = nil
