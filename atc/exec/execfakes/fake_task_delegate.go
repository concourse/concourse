...
type FakeTaskDelegate struct {
	...
	FetchImageStub        func(context.Context, atc.ImageResource, atc.ResourceTypes, atc.VarSourceConfigs, bool, atc.Tags) (worker.ImageSpec, error)
...
func (fake *FakeTaskDelegate) FetchImage(arg1 context.Context, arg2 atc.ImageResource, arg3 atc.ResourceTypes, arg4 atc.VarSourceConfigs, arg5 bool, arg6 atc.Tags) (worker.ImageSpec, error) {
...
func (fake *FakeTaskDelegate) FetchImageCalls(stub func(context.Context, atc.ImageResource, atc.ResourceTypes, atc.VarSourceConfigs, bool, atc.Tags) (worker.ImageSpec, error)) {
	fake.fetchImageMutex.Lock()
	defer fake.fetchImageMutex.Unlock()
	fake.FetchImageStub = stub
}

func (fake *FakeTaskDelegate) FetchImageArgsForCall(i int) (context.Context, atc.ImageResource, atc.ResourceTypes, atc.VarSourceConfigs, bool, atc.Tags) {
	fake.fetchImageMutex.RLock()
	defer fake.fetchImageMutex.RUnlock()
