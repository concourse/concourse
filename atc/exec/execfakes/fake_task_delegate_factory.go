...
func (fake *FakeTaskDelegateFactory) TaskDelegate(arg1 exec.RunState) exec.TaskDelegate {
	...
	fake.recordInvocation("TaskDelegate", []any{arg1})
...
func (fake *FakeTaskDelegateFactory) Invocations() map[string][][]any {
...
func (fake *FakeTaskDelegateFactory) recordInvocation(key string, args []any) {
