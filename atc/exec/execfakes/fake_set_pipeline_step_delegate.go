...
func (fake *FakeSetPipelineStepDelegate) FetchImage(arg1 context.Context, arg2 atc.ImageResource, arg3 atc.VersionedResourceTypes) (runtime.Artifact, error) {
...
func (fake *FakeSetPipelineStepDelegate) FetchImageCalls(stub func(context.Context, atc.ImageResource, atc.VersionedResourceTypes) (runtime.Artifact, error)) {
	fake.fetchImageMutex.Lock()
	defer fake.fetchImageMutex.Unlock()
	fake.FetchImageStub = stub
}

func (fake *FakeSetPipelineStepDelegate) FetchImageArgsForCall(i int) (context.Context, atc.ImageResource, atc.VersionedResourceTypes) {
	fake.fetchImageMutex.RLock()
	defer fake.fetchImageMutex.RUnlock()
...
func (fake *FakeSetPipelineStepDelegate) FetchImageReturns(result1 runtime.Artifact, result2 error) {
	fake.fetchImageMutex.Lock()
	defer fake.fetchImageMutex.Unlock()
...
func (fake *FakeSetPipelineStepDelegate) FetchImageReturnsOnCall(i int, result1 runtime.Artifact, result2 error) {
	fake.fetchImageMutex.Lock()
	defer fake.fetchImageMutex.Unlock()
	fake.FetchImageStub = nil
