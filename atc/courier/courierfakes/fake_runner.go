...
func (fake *FakeRunner) Run(arg1 <-chan os.Signal, arg2 chan<- struct{}) error {
	fake.runMutex.Lock()
...
func (fake *FakeRunner) RunCalls(stub func(<-chan os.Signal, chan<- struct{}) error) {
	fake.runMutex.Lock()
...
var _ courier.Runner = new(FakeRunner)
