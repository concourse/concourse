...
type FakeEngine struct {
	...
	NewBuildStub        func(db.Build) builds.Runnable
...
func (fake *FakeEngine) NewBuild(arg1 db.Build) builds.Runnable {
...
func (fake *FakeEngine) NewBuildCalls(stub func(db.Build) builds.Runnable) {
	fake.newBuildMutex.Lock()
...
func (fake *FakeEngine) NewBuildReturns(result1 builds.Runnable) {
	fake.newBuildMutex.Lock()
	defer fake.newBuildMutex.Unlock()
...
func (fake *FakeEngine) NewBuildReturnsOnCall(i int, result1 builds.Runnable) {
	fake.newBuildMutex.Lock()
	defer fake.newBuildMutex.Unlock()
	fake.NewBuildStub = nil
...
var _ builds.Engine = new(FakeEngine)
