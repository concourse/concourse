...
func NewHandler(
	...
	handlers := map[string]http.Handler{
		...
		atc.GetConfigByPipelineID:                     pipelineHandlerFactory.HandlerFor(configServer.GetConfig),
		atc.ListJobsByPipelineID:                      pipelineHandlerFactory.HandlerFor(jobServer.ListJobs),
		atc.GetJobByPipelineID:                        pipelineHandlerFactory.HandlerFor(jobServer.GetJob),
		atc.ListJobBuildsByPipelineID:                 pipelineHandlerFactory.HandlerFor(jobServer.ListJobBuilds),
		atc.ListJobInputsByPipelineID:                 pipelineHandlerFactory.HandlerFor(jobServer.ListJobInputs),
		atc.GetJobBuildByPipelineID:                   pipelineHandlerFactory.HandlerFor(jobServer.GetJobBuild),
		atc.CreateJobBuildByPipelineID:                pipelineHandlerFactory.HandlerFor(jobServer.CreateJobBuild),
		atc.RerunJobBuildByPipelineID:                 pipelineHandlerFactory.HandlerFor(jobServer.RerunJobBuild),
		atc.PauseJobByPipelineID:                      pipelineHandlerFactory.HandlerFor(jobServer.PauseJob),
		atc.UnpauseJobByPipelineID:                    pipelineHandlerFactory.HandlerFor(jobServer.UnpauseJob),
		atc.ScheduleJobByPipelineID:                   pipelineHandlerFactory.HandlerFor(jobServer.ScheduleJob),
		atc.JobBadgeByPipelineID:                      pipelineHandlerFactory.HandlerFor(jobServer.JobBadge),
		atc.ClearTaskCacheByPipelineID:                pipelineHandlerFactory.HandlerFor(jobServer.ClearTaskCache),
		atc.GetPipelineByPipelineID:                   pipelineHandlerFactory.HandlerFor(pipelineServer.GetPipeline),
		atc.DeletePipelineByPipelineID:                pipelineHandlerFactory.HandlerFor(pipelineServer.DeletePipeline),
		atc.PausePipelineByPipelineID:                 pipelineHandlerFactory.HandlerFor(pipelineServer.PausePipeline),
		atc.ArchivePipelineByPipelineID:               pipelineHandlerFactory.HandlerFor(pipelineServer.ArchivePipeline),
		atc.UnpausePipelineByPipelineID:               pipelineHandlerFactory.HandlerFor(pipelineServer.UnpausePipeline),
		atc.ExposePipelineByPipelineID:                pipelineHandlerFactory.HandlerFor(pipelineServer.ExposePipeline),
		atc.HidePipelineByPipelineID:                  pipelineHandlerFactory.HandlerFor(pipelineServer.HidePipeline),
		atc.GetVersionsDBByPipelineID:                 pipelineHandlerFactory.HandlerFor(pipelineServer.GetVersionsDB),
		atc.RenamePipelineByPipelineID:                pipelineHandlerFactory.HandlerFor(pipelineServer.RenamePipeline),
		atc.ListPipelineBuildsByPipelineID:            pipelineHandlerFactory.HandlerFor(pipelineServer.ListPipelineBuilds),
		atc.CreatePipelineBuildByPipelineID:           pipelineHandlerFactory.HandlerFor(pipelineServer.CreateBuild),
		atc.PipelineBadgeByPipelineID:                 pipelineHandlerFactory.HandlerFor(pipelineServer.PipelineBadge),
		atc.ListResourcesByPipelineID:                 pipelineHandlerFactory.HandlerFor(resourceServer.ListResources),
		atc.ListResourceTypesByPipelineID:             pipelineHandlerFactory.HandlerFor(resourceServer.ListVersionedResourceTypes),
		atc.GetResourceByPipelineID:                   pipelineHandlerFactory.HandlerFor(resourceServer.GetResource),
		atc.UnpinResourceByPipelineID:                 pipelineHandlerFactory.HandlerFor(resourceServer.UnpinResource),
		atc.SetPinCommentOnResourceByPipelineID:       pipelineHandlerFactory.HandlerFor(resourceServer.SetPinCommentOnResource),
		atc.CheckResourceByPipelineID:                 pipelineHandlerFactory.HandlerFor(resourceServer.CheckResource),
		atc.CheckResourceWebHookByPipelineID:          pipelineHandlerFactory.HandlerFor(resourceServer.CheckResourceWebHook),
		atc.CheckResourceTypeByPipelineID:             pipelineHandlerFactory.HandlerFor(resourceServer.CheckResourceType),
		atc.ListResourceVersionsByPipelineID:          pipelineHandlerFactory.HandlerFor(versionServer.ListResourceVersions),
		atc.GetResourceVersionByPipelineID:            pipelineHandlerFactory.HandlerFor(versionServer.GetResourceVersion),
		atc.EnableResourceVersionByPipelineID:         pipelineHandlerFactory.HandlerFor(versionServer.EnableResourceVersion),
		atc.DisableResourceVersionByPipelineID:        pipelineHandlerFactory.HandlerFor(versionServer.DisableResourceVersion),
		atc.PinResourceVersionByPipelineID:            pipelineHandlerFactory.HandlerFor(versionServer.PinResourceVersion),
		atc.ListBuildsWithVersionAsInputByPipelineID:  pipelineHandlerFactory.HandlerFor(versionServer.ListBuildsWithVersionAsInput),
		atc.ListBuildsWithVersionAsOutputByPipelineID: pipelineHandlerFactory.HandlerFor(versionServer.ListBuildsWithVersionAsOutput),
		atc.GetResourceCausalityByPipelineID:          pipelineHandlerFactory.HandlerFor(versionServer.GetCausality),
	}
