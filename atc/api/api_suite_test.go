...
import (
	...
	"github.com/concourse/concourse/atc/api/webhookserver/webhookserverfakes"
...
var (
	...
	dbWebhooks              *webhookserverfakes.FakeWebhooks
...
var _ = BeforeEach(func() {
	...
	dbWebhooks = new(webhookserverfakes.FakeWebhooks)
