...
var _ = Describe("Accessor", func() {
	...
	DescribeTable("role actions",
		...
		Entry("user :: table has no entry", "some-role", "user", false),
		...
		Entry("user :: "+atc.SaveConfig, atc.SaveConfig, "user", false),
		...
		Entry("user :: "+atc.GetConfig, atc.GetConfig, "user", true),
		...
		Entry("user :: "+atc.GetCC, atc.GetCC, "user", true),
		...
		Entry("user :: "+atc.GetBuild, atc.GetBuild, "user", true),
		...
		Entry("user :: "+atc.GetBuildPlan, atc.GetBuildPlan, "user", true),
		...
		Entry("user :: "+atc.CreateBuild, atc.CreateBuild, "user", false),
		...
		Entry("user :: "+atc.ListBuilds, atc.ListBuilds, "user", true),
		...
		Entry("user :: "+atc.BuildEvents, atc.BuildEvents, "user", true),
		...
		Entry("user :: "+atc.BuildResources, atc.BuildResources, "user", true),
		...
		Entry("user :: "+atc.AbortBuild, atc.AbortBuild, "user", true),
		...
		Entry("user :: "+atc.GetBuildPreparation, atc.GetBuildPreparation, "user", true),
		...
		Entry("user :: "+atc.GetJob, atc.GetJob, "user", true),
		...
		Entry("user :: "+atc.CreateJobBuild, atc.CreateJobBuild, "user", true),
		...
		Entry("user :: "+atc.ListAllJobs, atc.ListAllJobs, "user", true),
		...
		Entry("user :: "+atc.ListJobs, atc.ListJobs, "user", true),
		...
		Entry("user :: "+atc.ListJobBuilds, atc.ListJobBuilds, "user", true),
		...
		Entry("user :: "+atc.ListJobInputs, atc.ListJobInputs, "user", true),
		...
		Entry("user :: "+atc.GetJobBuild, atc.GetJobBuild, "user", true),
		...
		Entry("user :: "+atc.PauseJob, atc.PauseJob, "user", false),
		...
		Entry("user :: "+atc.UnpauseJob, atc.UnpauseJob, "user", false),
		...
		Entry("user :: "+atc.GetVersionsDB, atc.GetVersionsDB, "user", true),
		...
		Entry("user :: "+atc.JobBadge, atc.JobBadge, "user", true),
		...
		Entry("user :: "+atc.MainJobBadge, atc.MainJobBadge, "user", true),
		...
		Entry("user :: "+atc.ClearTaskCache, atc.ClearTaskCache, "user", false),
		...
		Entry("user :: "+atc.ListAllResources, atc.ListAllResources, "user", true),
		...
		Entry("user :: "+atc.ListResources, atc.ListResources, "user", true),
		...
		Entry("user :: "+atc.ListResourceTypes, atc.ListResourceTypes, "user", true),
		...
		Entry("user :: "+atc.GetResource, atc.GetResource, "user", true),
		...
		Entry("user :: "+atc.CheckResource, atc.CheckResource, "user", true),
		...
		Entry("user :: "+atc.CheckResourceWebHook, atc.CheckResourceWebHook, "user", false),
		...
		Entry("user :: "+atc.CheckResourceType, atc.CheckResourceType, "user", false),
		...
		Entry("user :: "+atc.ListResourceVersions, atc.ListResourceVersions, "user", true),
		...
		Entry("user :: "+atc.GetResourceVersion, atc.GetResourceVersion, "user", true),
		...
		Entry("user :: "+atc.EnableResourceVersion, atc.EnableResourceVersion, "user", false),
		...
		Entry("user :: "+atc.DisableResourceVersion, atc.DisableResourceVersion, "user", false),
		...
		Entry("user :: "+atc.ListBuildsWithVersionAsInput, atc.ListBuildsWithVersionAsInput, "user", true),
		...
		Entry("user :: "+atc.ListBuildsWithVersionAsOutput, atc.ListBuildsWithVersionAsOutput, "user", true),
		...
		Entry("user :: "+atc.GetResourceCausality, atc.GetResourceCausality, "user", true),
		...
		Entry("user :: "+atc.ListAllPipelines, atc.ListAllPipelines, "user", true),
		...
		Entry("user :: "+atc.ListPipelines, atc.ListPipelines, "user", true),
		...
		Entry("user :: "+atc.GetPipeline, atc.GetPipeline, "user", true),
		...
		Entry("user :: "+atc.DeletePipeline, atc.DeletePipeline, "user", false),
		...
		Entry("user :: "+atc.OrderPipelines, atc.OrderPipelines, "user", false),
		...
		Entry("user :: "+atc.PausePipeline, atc.PausePipeline, "user", false),
		...
		Entry("user :: "+atc.UnpausePipeline, atc.UnpausePipeline, "user", false),
		...
		Entry("user :: "+atc.ExposePipeline, atc.ExposePipeline, "user", false),
		...
		Entry("user :: "+atc.HidePipeline, atc.HidePipeline, "user", false),
		...
		Entry("user :: "+atc.RenamePipeline, atc.RenamePipeline, "user", false),
		...
		Entry("user :: "+atc.ListPipelineBuilds, atc.ListPipelineBuilds, "user", true),
		...
		Entry("user :: "+atc.CreatePipelineBuild, atc.CreatePipelineBuild, "user", false),
		...
		Entry("user :: "+atc.PipelineBadge, atc.PipelineBadge, "user", true),
		...
		Entry("user :: "+atc.RegisterWorker, atc.RegisterWorker, "user", false),
		...
		Entry("user :: "+atc.LandWorker, atc.LandWorker, "user", false),
		...
		Entry("user :: "+atc.RetireWorker, atc.RetireWorker, "user", false),
		...
		Entry("user :: "+atc.PruneWorker, atc.PruneWorker, "user", false),
		...
		Entry("user :: "+atc.HeartbeatWorker, atc.HeartbeatWorker, "user", false),
		...
		Entry("user :: "+atc.ListWorkers, atc.ListWorkers, "user", true),
		...
		Entry("user :: "+atc.DeleteWorker, atc.DeleteWorker, "user", false),
		...
		Entry("user :: "+atc.SetLogLevel, atc.SetLogLevel, "user", false),
		...
		Entry("user :: "+atc.GetLogLevel, atc.GetLogLevel, "user", true),
		...
		Entry("user :: "+atc.DownloadCLI, atc.DownloadCLI, "user", true),
		...
		Entry("user :: "+atc.GetInfo, atc.GetInfo, "user", true),
		...
		Entry("user :: "+atc.GetInfoCreds, atc.GetInfoCreds, "user", true),
		...
		Entry("user :: "+atc.ListContainers, atc.ListContainers, "user", true),
		...
		Entry("user :: "+atc.GetContainer, atc.GetContainer, "user", true),
		...
		Entry("user :: "+atc.HijackContainer, atc.HijackContainer, "user", true),
		...
		Entry("user :: "+atc.ListDestroyingContainers, atc.ListDestroyingContainers, "user", true),
		...
		Entry("user :: "+atc.ReportWorkerContainers, atc.ReportWorkerContainers, "user", false),
		...
		Entry("user :: "+atc.ListVolumes, atc.ListVolumes, "user", true),
		...
		Entry("user :: "+atc.ListDestroyingVolumes, atc.ListDestroyingVolumes, "user", true),
		...
		Entry("user :: "+atc.ReportWorkerVolumes, atc.ReportWorkerVolumes, "user", false),
		...
		Entry("user :: "+atc.ListTeams, atc.ListTeams, "user", true),
		...
		Entry("user :: "+atc.GetTeam, atc.GetTeam, "user", true),
		...
		Entry("user :: "+atc.SetTeam, atc.SetTeam, "user", false),
		...
		Entry("user :: "+atc.RenameTeam, atc.RenameTeam, "user", false),
		...
		Entry("user :: "+atc.DestroyTeam, atc.DestroyTeam, "user", false),
		...
		Entry("user :: "+atc.ListTeamBuilds, atc.ListTeamBuilds, "user", true),
		...
		Entry("user :: "+atc.CreateArtifact, atc.CreateArtifact, "user", false),
		...
		Entry("user :: "+atc.GetArtifact, atc.GetArtifact, "user", false),
		...
		Entry("user :: "+atc.ListBuildArtifacts, atc.ListBuildArtifacts, "user", true),
