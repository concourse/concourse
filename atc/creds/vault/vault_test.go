...
var _ = Describe("Vault", func() {
	...
	BeforeEach(func() {
		...
		variables = creds.NewVariables(v, creds.SecretLookupContext{Team: "team", Pipeline: "pipeline"}, false)
		...
		Context("when logged in successfully", func() {
			...
			Context("allowRootPath", func() {
				...
				Context("is true", func() {
					BeforeEach(func() {
						variables = creds.NewVariables(v, creds.SecretLookupContext{Team: "team", Pipeline: "pipeline"}, true)
					})
