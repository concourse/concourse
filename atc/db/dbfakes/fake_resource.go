...
type FakeResource struct {
	...
	ResourceVersionIDStub        func(atc.Version) (int, bool, error)
	resourceVersionIDMutex       sync.RWMutex
	resourceVersionIDArgsForCall []struct {
		arg1 atc.Version
	}
	resourceVersionIDReturns struct {
		result1 int
		result2 bool
		result3 error
	}
	resourceVersionIDReturnsOnCall map[int]struct {
		result1 int
		result2 bool
		result3 error
	}
...
func (fake *FakeResource) ResourceVersionID(arg1 atc.Version) (int, bool, error) {
	fake.resourceVersionIDMutex.Lock()
	ret, specificReturn := fake.resourceVersionIDReturnsOnCall[len(fake.resourceVersionIDArgsForCall)]
	fake.resourceVersionIDArgsForCall = append(fake.resourceVersionIDArgsForCall, struct {
		arg1 atc.Version
	}{arg1})
	fake.recordInvocation("ResourceVersionID", []interface{}{arg1})
	fake.resourceVersionIDMutex.Unlock()
	if fake.ResourceVersionIDStub != nil {
		return fake.ResourceVersionIDStub(arg1)
	}
	if specificReturn {
		return ret.result1, ret.result2, ret.result3
	}
	fakeReturns := fake.resourceVersionIDReturns
	return fakeReturns.result1, fakeReturns.result2, fakeReturns.result3
}

func (fake *FakeResource) ResourceVersionIDCallCount() int {
	fake.resourceVersionIDMutex.RLock()
	defer fake.resourceVersionIDMutex.RUnlock()
	return len(fake.resourceVersionIDArgsForCall)
}

func (fake *FakeResource) ResourceVersionIDCalls(stub func(atc.Version) (int, bool, error)) {
	fake.resourceVersionIDMutex.Lock()
	defer fake.resourceVersionIDMutex.Unlock()
	fake.ResourceVersionIDStub = stub
}

func (fake *FakeResource) ResourceVersionIDArgsForCall(i int) atc.Version {
	fake.resourceVersionIDMutex.RLock()
	defer fake.resourceVersionIDMutex.RUnlock()
	argsForCall := fake.resourceVersionIDArgsForCall[i]
	return argsForCall.arg1
}

func (fake *FakeResource) ResourceVersionIDReturns(result1 int, result2 bool, result3 error) {
	fake.resourceVersionIDMutex.Lock()
	defer fake.resourceVersionIDMutex.Unlock()
	fake.ResourceVersionIDStub = nil
	fake.resourceVersionIDReturns = struct {
		result1 int
		result2 bool
		result3 error
...
func (fake *FakeResource) ResourceVersionIDReturnsOnCall(i int, result1 int, result2 bool, result3 error) {
	fake.resourceVersionIDMutex.Lock()
	defer fake.resourceVersionIDMutex.Unlock()
	fake.ResourceVersionIDStub = nil
	if fake.resourceVersionIDReturnsOnCall == nil {
		fake.resourceVersionIDReturnsOnCall = make(map[int]struct {
			result1 int
			result2 bool
			result3 error
		})
	}
	fake.resourceVersionIDReturnsOnCall[i] = struct {
		result1 int
		result2 bool
		result3 error
	}{result1, result2, result3}
