...
func (fake *FakeTeam) Admin() bool {
	...
	fake.recordInvocation("Admin", []any{})
...
func (fake *FakeTeam) Containers() ([]db.Container, error) {
	...
	fake.recordInvocation("Containers", []any{})
...
func (fake *FakeTeam) FindCheckContainers(arg1 lager.Logger, arg2 atc.PipelineRef, arg3 string) ([]db.Container, map[int]time.Time, error) {
	...
	fake.recordInvocation("FindCheckContainers", []any{arg1, arg2, arg3})
...
func (fake *FakeTeam) FindContainerByHandle(arg1 string) (db.Container, bool, error) {
	...
	fake.recordInvocation("FindContainerByHandle", []any{arg1})
...
func (fake *FakeTeam) FindContainersByMetadata(arg1 db.ContainerMetadata) ([]db.Container, error) {
	...
	fake.recordInvocation("FindContainersByMetadata", []any{arg1})
...
func (fake *FakeTeam) FindCreatedContainerByHandle(arg1 string) (db.CreatedContainer, bool, error) {
	...
	fake.recordInvocation("FindCreatedContainerByHandle", []any{arg1})
...
func (fake *FakeTeam) FindVolumeForWorkerArtifact(arg1 int) (db.CreatedVolume, bool, error) {
	...
	fake.recordInvocation("FindVolumeForWorkerArtifact", []any{arg1})
...
func (fake *FakeTeam) FindWorkerForContainer(arg1 string) (db.Worker, bool, error) {
	...
	fake.recordInvocation("FindWorkerForContainer", []any{arg1})
...
func (fake *FakeTeam) FindWorkerForVolume(arg1 string) (db.Worker, bool, error) {
	...
	fake.recordInvocation("FindWorkerForVolume", []any{arg1})
...
func (fake *FakeTeam) FindWorkersForResourceCache(arg1 int, arg2 time.Time) ([]db.Worker, error) {
	...
	fake.recordInvocation("FindWorkersForResourceCache", []any{arg1, arg2})
...
func (fake *FakeTeam) IsCheckContainer(arg1 string) (bool, error) {
	...
	fake.recordInvocation("IsCheckContainer", []any{arg1})
...
func (fake *FakeTeam) IsContainerWithinTeam(arg1 string, arg2 bool) (bool, error) {
	...
	fake.recordInvocation("IsContainerWithinTeam", []any{arg1, arg2})
...
func (fake *FakeTeam) OrderPipelines(arg1 []string) error {
	...
	fake.recordInvocation("OrderPipelines", []any{arg1Copy})
...
func (fake *FakeTeam) OrderPipelinesWithinGroup(arg1 string, arg2 []atc.InstanceVars) error {
	...
	fake.recordInvocation("OrderPipelinesWithinGroup", []any{arg1, arg2Copy})
...
func (fake *FakeTeam) Pipelines() ([]db.Pipeline, error) {
	...
	fake.recordInvocation("Pipelines", []any{})
...
func (fake *FakeTeam) PrivateAndPublicBuilds(arg1 db.Page) ([]db.BuildForAPI, db.Pagination, error) {
	...
	fake.recordInvocation("PrivateAndPublicBuilds", []any{arg1})
...
func (fake *FakeTeam) PublicPipelines() ([]db.Pipeline, error) {
	...
	fake.recordInvocation("PublicPipelines", []any{})
...
func (fake *FakeTeam) Rename(arg1 string) error {
	...
	fake.recordInvocation("Rename", []any{arg1})
...
func (fake *FakeTeam) SavePipeline(arg1 atc.PipelineRef, arg2 atc.Config, arg3 db.ConfigVersion, arg4 bool) (db.Pipeline, bool, error) {
	...
	fake.recordInvocation("SavePipeline", []any{arg1, arg2, arg3, arg4})
...
func (fake *FakeTeam) UpdateProviderAuth(arg1 atc.TeamAuth) error {
	...
	fake.recordInvocation("UpdateProviderAuth", []any{arg1})
