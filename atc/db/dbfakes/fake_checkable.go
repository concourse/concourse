...
func (fake *FakeCheckable) CheckPlan(arg1 atc.PlanFactory, arg2 db.ImagePlanner, arg3 atc.VarSourceConfigs, arg4 atc.Version, arg5 time.Duration, arg6 atc.Source, arg7 bool, arg8 bool) (atc.Plan, error) {
...
func (fake *FakeCheckable) CheckPlanCalls(stub func(atc.PlanFactory, db.ImagePlanner, atc.VarSourceConfigs, atc.Version, time.Duration, atc.Source, bool, bool) (atc.Plan, error)) {
	fake.checkPlanMutex.Lock()
	defer fake.checkPlanMutex.Unlock()
	fake.CheckPlanStub = stub
}

func (fake *FakeCheckable) CheckPlanArgsForCall(i int) (atc.PlanFactory, db.ImagePlanner, atc.VarSourceConfigs, atc.Version, time.Duration, atc.Source, bool, bool) {
	fake.checkPlanMutex.RLock()
	defer fake.checkPlanMutex.RUnlock()
...
func (fake *FakeCheckable) CheckPlanReturns(result1 atc.Plan, result2 error) {
	fake.checkPlanMutex.Lock()
	defer fake.checkPlanMutex.Unlock()
...
func (fake *FakeCheckable) CheckPlanReturnsOnCall(i int, result1 atc.Plan, result2 error) {
	fake.checkPlanMutex.Lock()
	defer fake.checkPlanMutex.Unlock()
	fake.CheckPlanStub = nil
