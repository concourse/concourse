...
type FakeResourceConfigFactory struct {
	...
	FindOrCreateResourceConfigStub        func(lager.Logger, string, atc.Source, atc.VersionedResourceTypes) (db.ResourceConfig, error)
...
func (fake *FakeResourceConfigFactory) FindOrCreateResourceConfig(arg1 lager.Logger, arg2 string, arg3 atc.Source, arg4 atc.VersionedResourceTypes) (db.ResourceConfig, error) {
...
func (fake *FakeResourceConfigFactory) FindOrCreateResourceConfigCalls(stub func(lager.Logger, string, atc.Source, atc.VersionedResourceTypes) (db.ResourceConfig, error)) {
	fake.findOrCreateResourceConfigMutex.Lock()
	defer fake.findOrCreateResourceConfigMutex.Unlock()
	fake.FindOrCreateResourceConfigStub = stub
}

func (fake *FakeResourceConfigFactory) FindOrCreateResourceConfigArgsForCall(i int) (lager.Logger, string, atc.Source, atc.VersionedResourceTypes) {
	fake.findOrCreateResourceConfigMutex.RLock()
	defer fake.findOrCreateResourceConfigMutex.RUnlock()
