...
type FakeResourceConfigFactory struct {
	...
	FindOrCreateResourceConfigStub        func(string, atc.Source, db.UsedResourceCache) (db.ResourceConfig, error)
...
func (fake *FakeResourceConfigFactory) FindOrCreateResourceConfig(arg1 string, arg2 atc.Source, arg3 db.UsedResourceCache) (db.ResourceConfig, error) {
...
func (fake *FakeResourceConfigFactory) FindOrCreateResourceConfigCalls(stub func(string, atc.Source, db.UsedResourceCache) (db.ResourceConfig, error)) {
	fake.findOrCreateResourceConfigMutex.Lock()
	defer fake.findOrCreateResourceConfigMutex.Unlock()
	fake.FindOrCreateResourceConfigStub = stub
}

func (fake *FakeResourceConfigFactory) FindOrCreateResourceConfigArgsForCall(i int) (string, atc.Source, db.UsedResourceCache) {
	fake.findOrCreateResourceConfigMutex.RLock()
	defer fake.findOrCreateResourceConfigMutex.RUnlock()
