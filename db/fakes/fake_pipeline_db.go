...
func (fake *FakePipelineDB) GetJobBuild(job string, build string) (db.BuildDB, bool, error) {
...
func (fake *FakePipelineDB) GetJobBuildReturns(result1 db.BuildDB, result2 bool, result3 error) {
