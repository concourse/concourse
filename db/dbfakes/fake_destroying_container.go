...
func (fake *FakeDestroyingContainer) TeamID() int {
...
func (fake *FakeDestroyingContainer) TeamIDCallCount() int {
	fake.teamIDMutex.RLock()
	defer fake.teamIDMutex.RUnlock()
	return len(fake.teamIDArgsForCall)
}

func (fake *FakeDestroyingContainer) TeamIDReturns(result1 int) {
	fake.TeamIDStub = nil
...
func (fake *FakeDestroyingContainer) TeamIDReturnsOnCall(i int, result1 int) {
	fake.TeamIDStub = nil
