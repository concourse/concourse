...
type FakePipeline struct {
	...
	ConfigStub        func() (atc.Config, atc.RawConfig, db.ConfigVersion, error)
	...
	AcquireResourceCheckingLockWithIntervalCheckStub        func(logger lager.Logger, resource db.Resource, interval time.Duration, immediate bool) (lock.Lock, bool, error)
...
func (fake *FakePipeline) Config() (atc.Config, atc.RawConfig, db.ConfigVersion, error) {
...
func (fake *FakePipeline) ConfigReturns(result1 atc.Config, result2 atc.RawConfig, result3 db.ConfigVersion, result4 error) {
	fake.ConfigStub = nil
...
func (fake *FakePipeline) ConfigReturnsOnCall(i int, result1 atc.Config, result2 atc.RawConfig, result3 db.ConfigVersion, result4 error) {
	fake.ConfigStub = nil
...
func (fake *FakePipeline) AcquireResourceCheckingLockWithIntervalCheck(logger lager.Logger, resource db.Resource, interval time.Duration, immediate bool) (lock.Lock, bool, error) {
...
func (fake *FakePipeline) AcquireResourceCheckingLockWithIntervalCheckArgsForCall(i int) (lager.Logger, db.Resource, time.Duration, bool) {
	fake.acquireResourceCheckingLockWithIntervalCheckMutex.RLock()
	defer fake.acquireResourceCheckingLockWithIntervalCheckMutex.RUnlock()
...
func (fake *FakePipeline) Jobs() ([]db.Job, error) {
	fake.jobsMutex.Lock()
...
func (fake *FakePipeline) JobsReturns(result1 []db.Job, result2 error) {
	fake.JobsStub = nil
...
func (fake *FakePipeline) JobsReturnsOnCall(i int, result1 []db.Job, result2 error) {
	fake.JobsStub = nil
