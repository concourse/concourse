...
func (fake *FakeContainer) TeamID() int {
...
func (fake *FakeContainer) TeamIDCallCount() int {
	fake.teamIDMutex.RLock()
	defer fake.teamIDMutex.RUnlock()
	return len(fake.teamIDArgsForCall)
}

func (fake *FakeContainer) TeamIDReturns(result1 int) {
	fake.TeamIDStub = nil
...
func (fake *FakeContainer) TeamIDReturnsOnCall(i int, result1 int) {
	fake.TeamIDStub = nil
