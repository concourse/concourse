...
func (cmd QuickstartCommand) LessenRequirements(b *binder.Binder) {
	cmd.WebCommand.LessenRequirements(b)
	cmd.WorkerCommand.LessenRequirements("worker-", b)

	// autogenerated
	b.Lessen("tsa-authorized-keys", "tsa-host-key", "worker-tsa-worker-private-key")
}
