...
func (WebCommand) LessenRequirements(b *binder.Binder) {
	// defaults to atc external URL
	b.Lessen("tsa-atc-url", "tsa-token-url")

	// generated by default
	b.Lessen("session-signing-key")

	// defaults are derived from the signing key
	b.Lessen("client-secret", "tsa-client-secret")
}
