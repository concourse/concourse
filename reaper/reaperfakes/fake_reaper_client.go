...
func (fake *FakeReaperClient) DestroyContainers(handles []string) error {
...
func (fake *FakeReaperClient) DestroyContainersCallCount() int {
	fake.destroyContainersMutex.RLock()
	defer fake.destroyContainersMutex.RUnlock()
	return len(fake.destroyContainersArgsForCall)
}

func (fake *FakeReaperClient) DestroyContainersArgsForCall(i int) []string {
	fake.destroyContainersMutex.RLock()
	defer fake.destroyContainersMutex.RUnlock()
	return fake.destroyContainersArgsForCall[i].handles
}

func (fake *FakeReaperClient) DestroyContainersReturns(result1 error) {
...
func (fake *FakeReaperClient) DestroyContainersReturnsOnCall(i int, result1 error) {
	fake.DestroyContainersStub = nil
...
func (fake *FakeReaperClient) Ping() error {
	fake.pingMutex.Lock()
...
func (fake *FakeReaperClient) PingCallCount() int {
	fake.pingMutex.RLock()
	defer fake.pingMutex.RUnlock()
	return len(fake.pingArgsForCall)
}

func (fake *FakeReaperClient) PingReturns(result1 error) {
	fake.PingStub = nil
...
func (fake *FakeReaperClient) PingReturnsOnCall(i int, result1 error) {
	fake.PingStub = nil
...
func (fake *FakeReaperClient) recordInvocation(key string, args []interface{}) {
...
var _ reaper.ReaperClient = new(FakeReaperClient)
