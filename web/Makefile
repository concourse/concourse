...
public/elm.js: $(ELM_FILES)
	cd elm && elm make --warn --output ../public/elm.js --yes src/BuildPage.elm src/JobPage.elm src/LoginPage.elm src/PipelinePage.elm src/PipelinesNavPage.elm src/TopBarPage.elm
