...
givenDataAndUser : (Maybe Concourse.User -> Concourse.APIData) -> Concourse.User -> Dashboard.Model -> Dashboard.Model
...
givenDataUnauthenticated : (Maybe Concourse.User -> Concourse.APIData) -> Dashboard.Model -> Dashboard.Model
