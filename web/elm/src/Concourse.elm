...
type alias Pipeline =
    ...
    , backgroundOpacity : Maybe String
...
encodePipeline pipeline =
    Json.Encode.object
        ...
        , ( "display", Json.Encode.object [ ( "background_opacity", pipeline.backgroundOpacity |> Json.Encode.Extra.maybe Json.Encode.string ) ] )
...
decodePipeline =
    Json.Decode.succeed Pipeline
        ...
        |> andMap (Json.Decode.maybe (Json.Decode.at [ "display", "background_opacity" ] Json.Decode.string))
